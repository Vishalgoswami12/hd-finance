    ...
    <section id="Service" className="p-10 bg-sky-900">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className='relative'>
          <figure>
            <img src={require("../assets/photo-1620912189865-1e8a33da4c5e.avif" ) } alt="hello" />
          </figure>
        ...
        <div className='relative'>
          <figure>
            <img src={require("../assets/photo-1467232004584-a241de8bcf5d.avif")} alt="hello" /> 
          </figure>
          <div className='bg-slate-600 bg-opacity-75 absolute top-40 bottom-0 p-2'>
        ...
        <div className='relative'>
          <figure>
            <img src={require("../assets/photo-1611784728558-6c7d9b409cdf.avif")}  alt="hello"/> 
          </figure>
          <div className='bg-slate-600 bg-opacity-75 absolute top-40 bottom-0 p-2'>
